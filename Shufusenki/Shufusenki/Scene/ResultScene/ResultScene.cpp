...
void ResultScene::LoadResouce()
{
	...
	m_pDirectX->LoadTexture("Resource/Texture/result/result.png", "RESULT_BG_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/resultLast.png", "RESULT_POP_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/R_UI.png", "RESULT_END_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/star1.png", "RESULT_STAR1_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/star2.png", "RESULT_STAR2_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/star3.png", "RESULT_STAR3_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/point100.png", "RESULT_COMBOTEXT1_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/point300.png", "RESULT_COMBOTEXT2_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/point500.png", "RESULT_COMBOTEXT3_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/bonus.png", "RESULT_COMBO_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/SALE.png", "RESULT_SALE_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/result/price.png", "RESULT_NOMAL_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/yasuko_motion1.png", "YASUKO_EMOTION1_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/yasuko_motion2.png", "YASUKO_EMOTION2_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/yasuko_motion3.png", "YASUKO_EMOTION3_TEX");

	m_pDirectX->LoadTexture("Resource/Texture/merchandise/buridaikon.png", "BURIDAIKON_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/merchandise/tsumami.png", "RELISH_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/merchandise/teatime.png", "TEATIME_TEX");

	m_pDirectX->LoadTexture("Resource/Texture/merchandise/curry.png", "CURRY_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/merchandise/hamberg.png", "HAMBERG_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/merchandise/sashimi.png", "ASSORTEDSASHIMI_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/merchandise/oyatsu.png", "AFTERNOONREFRESHMENT_TEX");

	m_pDirectX->LoadTexture("Resource/Texture/merchandise/soup.png", "SOUP_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/merchandise/nimono.png", "NIMONO_TEX");
	m_pDirectX->LoadTexture("Resource/Texture/merchandise/parfait.png", "PARFAIT_TEX");
